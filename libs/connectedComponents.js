...
var connectedComponentLabeler = (function () {
    function connectedComponentLabeler(width, height, data) {
        _classCallCheck(this, connectedComponentLabeler);
    ...
    _createClass(connectedComponentLabeler, [{
        key: "connectAll",
        ...
        key: "flood",
        value: function flood(x1, y1, label) {
            var members = [];
            var list = [[x1, y1]];
        ...
        key: "labelAt",
        value: function labelAt(x, y) {
            return this.labels[this.width * y + x];
        }
    }, {
        key: "groupAt",
        value: function groupAt(x, y) {
...
//exports.connectedComponentLabeler = connectedComponentLabeler;

var group = (function () {
    function group(value, members) {
